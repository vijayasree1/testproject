...
<head>
    ...
    <link href='{{config('l5-swagger.paths.assets_public')}}/css/custom.css' media='print' rel='stylesheet' type='text/css'/>
        ...
        $(function () {
            ...
            function addApiKeyAuthorization(){
                ...
                if(key && key.trim() != "") {
                    ...
                    window.swaggerUi.api.clientAuthorizations.add("key", new SwaggerClient.ApiKeyAuthorization("Authorization", "Bearer", "header"));
                }
            }
